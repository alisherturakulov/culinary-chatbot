 ...
 * Description:       Adds a chatbot to the Culinary Argan Oil website pages powered by the gemini api
 * Version:           1.0
...
function cac_enqueue_assets() {
    ...
    // Load your JS file (dependent on jQuery, version 1.0, load in footer = true)
...
// Hook this function into the script loading process
add_action('wp_enqueue_scripts', 'cac_enqueue_assets');


// 2. Inject Chatbot HTML into Footer (Replaces your HTML file)
function cac_add_chatbot_html() {
    // We simply paste the HTML structure you designed
    ?>
...
// Hook this into the footer so it appears on every page,
...
function cac_handle_chat_request() {
    // Security: Verify the request came from your site and not a hacker
...
// Hook for handling admins and logged in users
